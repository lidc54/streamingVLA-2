...
# libero_10_mapping={
#     'turn on the stove and put the moka pot on it': 'KITCHEN SCENE3 turn on the stove and put the moka pot on it', 
#     'put the black bowl in the bottom drawer of the cabinet and close it': 'KITCHEN SCENE4 put the black bowl in the bottom drawer of the cabinet and close it', 
#     'put the yellow and white mug in the microwave and close it': 'KITCHEN SCENE6 put the yellow and white mug in the microwave and close it', 
#     'put both moka pots on the stove': 'KITCHEN SCENE8 put both moka pots on the stove', 
#     'put both the alphabet soup and the cream cheese box in the basket': 'LIVING ROOM SCENE1 put both the alphabet soup and the cream cheese box in the basket', 
#     'put both the alphabet soup and the tomato sauce in the basket': 'LIVING ROOM SCENE2 put both the alphabet soup and the tomato sauce in the basket', 
#     'put both the cream cheese box and the butter in the basket': 'LIVING ROOM SCENE2 put both the cream cheese box and the butter in the basket', 
#     'put the white mug on the left plate and put the yellow and white mug on the right plate': 'LIVING ROOM SCENE5 put the white mug on the left plate and put the yellow and white mug on the right plate', 
#     'put the white mug on the plate and put the chocolate pudding to the right of the plate': 'LIVING ROOM SCENE6 put the white mug on the plate and put the chocolate pudding to the right of the plate', 
#     'pick up the book and place it in the back compartment of the caddy': 'STUDY SCENE1 pick up the book and place it in the back compartment of the caddy'
# }
# task_description=libero_10_mapping[task_description]
...
def eval_libero(args: Args) -> None:
    ...
    for task_id in tqdm(range(num_tasks_in_suite), desc="Tasks"):
        ...
        for episode_idx in tqdm(
            ...
            action_states = torch.zeros((1, 7), dtype=torch.float32, device=args.device)
            ...
            while t < max_steps:
                try:
                    ...
                    with torch.inference_mode():
                        action_tensor = policy.select_action(observation, noise=action_states)
                    action_states += action_tensor
